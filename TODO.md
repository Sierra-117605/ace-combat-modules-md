...
- [~] [本人] HOI4 起動・MD β版 + ACM-MD のロード成功(2026-07-18 再検証中)
  - 2026-06-28 の本人「問題ない」報告は事実誤認だった可能性大
    (setup.log / game.log に acm 関連エントリ 0件 = 本MOD が load されていなかった)
  - 原因: `mod/acm-md.mod` の `path=` が絶対パスに書き換わっていた
    (HOI4 1.19 launcher の path 絶対パス書き換え問題、KNOWLEDGE.md 参照)
  - 対策実施済み(2026-07-18): 相対パス化 + `chmod 444` (readonly) 設定
  - 本人の HOI4 再起動 + setup.log 確認で load 成立を再検証する必要あり
