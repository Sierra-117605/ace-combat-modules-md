...
- [~] [Codex] 最初のモジュール1個を実装(ファイル作成) — **PLSL** 試作
  - 指示書: `instructions/2026-06-28_p5_prototype_plsl.md`
  - 本MOD初の動く実装。本命作品選定(P4)前でも実装試行可能
- [~] [Codex] アイコンを既存流用 or 配置(PLSL試作の一部、上記指示書内)
- [~] [Codex] ローカライゼーション(英語、日本語)(PLSL試作の一部、上記指示書内)
- [ ] [本人] HOI4起動、モジュール画面で PLSL が表示されるか確認
- [ ] [本人] ゲーム内で PLSL の性能修正値が適用されるか確認
